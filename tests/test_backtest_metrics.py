...
def test_worst_trades_sorted_asc():
    ...
    trades = [
        SimulatedTrade(
            "m1",
            "BTC",
            TradeDecision("BUY_YES", 0.5, 10.0, "t", "ML_TREND"),
            0.5,
            0.0,
            10.0,
            20.0,
    ...
    replays = {
        "m1": MarketReplay(
            [MockSnap("m1", "YES"), MockSnap("m1", "YES"), MockSnap("m1", "YES")]
        ),
        "m2": MarketReplay(
            [MockSnap("m2", "NO"), MockSnap("m2", "NO"), MockSnap("m2", "NO")]
        ),
        "m3": MarketReplay(
            [MockSnap("m3", "YES"), MockSnap("m3", "YES"), MockSnap("m3", "YES")]
        ),
    }
    ...
    assert pnls == sorted(
        pnls
    ), "worst_trades должен быть отсортирован по возрастанию PnL"
