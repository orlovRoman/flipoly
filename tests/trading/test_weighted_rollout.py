...
def test_mapping_does_not_treat_effective_candidate_probability_as_logreg_raw():
    item = MarketObservation.from_mapping(
        {
            "market_id": "effective-only",
            "timestamp": "2026-01-01T00:00:00Z",
            "asset": "BTC",
            "yes_ask": 0.60,
            "no_ask": 0.40,
            "outcome_yes": "YES",
            "candidate_side": "BUY_YES",
            "p_candidate_win": 0.80,
        }
    )
    assert item.p_logreg_yes is None
