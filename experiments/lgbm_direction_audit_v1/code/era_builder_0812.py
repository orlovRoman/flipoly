# Vendored from 463a8c77 (08-12: post-consec-fix, pre-ddof-change). DO NOT EDIT.
"""
РџРѕСЃС‚СЂРѕРµРЅРёРµ РІРµРєС‚РѕСЂР° С„РёС‡РµР№ РґР»СЏ Up/Down РјРѕРґРµР»Рё РїРѕ 15m-СЃРІРµС‡Р°Рј.

Р’С…РѕРґРЅС‹Рµ РґР°РЅРЅС‹Рµ : РїРѕСЃР»РµРґРЅРёРµ 100вЂ“200 СЃРІРµС‡РµР№ CryptoCandle (ASC РїРѕ open_time).
Р’С‹С…РѕРґРЅС‹Рµ РґР°РЅРЅС‹Рµ: numpy array shape (1, N) + CRYPTO_FEATURE_COLUMNS.

РџСЂРёРЅС†РёРїС‹:
  - РўРѕР»СЊРєРѕ pandas + numpy. РќРёРєР°РєРёС… РІРЅРµС€РЅРёС… Р·Р°РІРёСЃРёРјРѕСЃС‚РµР№.
  - Р’СЃРµ РІС‹С‡РёСЃР»РµРЅРёСЏ РґРµС‚РµСЂРјРёРЅРёСЂРѕРІР°РЅС‹.
  - РќРµС‚ lookahead: РёСЃРїРѕР»СЊР·СѓРµРј С‚РѕР»СЊРєРѕ СЃРІРµС‡Рё РґРѕ С‚РµРєСѓС‰РµР№ РІРєР»СЋС‡РёС‚РµР»СЊРЅРѕ.
  - NaN/Inf в†’ 0.0 С‡РµСЂРµР· np.nan_to_num (safety net).
"""
...
CRYPTO_FEATURE_COLUMNS: list[str] = [
    # --- Returns (log) ---
    "ret_1",        # log-return РїРѕСЃР»РµРґРЅРµР№ СЃРІРµС‡Рё
    "ret_3",        # log-return Р·Р° 3 СЃРІРµС‡Рё  (в‰€45 РјРёРЅ)
    "ret_6",        # log-return Р·Р° 6 СЃРІРµС‡РµР№ (в‰€90 РјРёРЅ)
    # --- Volatility ---
    "vol_6",        # std log-returns Р·Р° 6 СЃРІРµС‡РµР№
    "vol_24",       # std log-returns Р·Р° 24 СЃРІРµС‡Рё
    "vol_trend",    # vol_6 / vol_24 вЂ” РЅР°СЂР°СЃС‚Р°РЅРёРµ РєСЂР°С‚РєРѕСЃСЂРѕС‡РЅРѕР№ РІРѕР»Р°С‚РёР»СЊРЅРѕСЃС‚Рё
    # --- Volume anomaly & CVD ---
    "vol_z_1",          # z-score РѕР±СЉС‘РјР° С‚РµРєСѓС‰РµР№ СЃРІРµС‡Рё РѕС‚РЅРѕСЃРёС‚РµР»СЊРЅРѕ 24-СЃРІРµС‡РЅРѕРіРѕ РѕРєРЅР°
    "taker_buy_ratio",  # taker_buy_volume / volume вЂ” РґР°РІР»РµРЅРёРµ РїРѕРєСѓРїР°С‚РµР»РµР№ (0..1)
    "cvd_1",            # РЅРѕСЂРјР°Р»РёР·РѕРІР°РЅРЅР°СЏ РґРµР»СЊС‚Р° Р·Р° 1 СЃРІРµС‡Сѓ
    "cvd_6",            # РЅР°РєРѕРїР»РµРЅРЅС‹Р№ РґРёСЃР±Р°Р»Р°РЅСЃ Р·Р° 6 СЃРІРµС‡РµР№
    ...
    "dist_to_high_24",   # (close - max_high_24) / close  в‰¤ 0
    "dist_to_low_24",    # (close - min_low_24)  / close  в‰Ґ 0
    # --- Range ---
    "range_1",           # (high - low) / close С‚РµРєСѓС‰РµР№ СЃРІРµС‡Рё
    "range_avg_24",      # СЃСЂРµРґРЅРёР№ range Р·Р° 24 СЃРІРµС‡Рё
    # --- Consecutive candles ---
    "consec_balance",    # Р±Р°Р»Р°РЅСЃ СЃРµСЂРёР№ СЃРІРµС‡РµР№ (consec_up - consec_down)
    # --- Time (Cyclic) ---
...
class CryptoFeatureVector:
    ...
    valid:     bool             # False РµСЃР»Рё РјРµРЅСЊС€Рµ min_candles РёСЃС‚РѕСЂРёРё
...
def build_crypto_features(
    ...
    # в”Ђв”Ђ 1. Returns в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ 2. Volatility в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ 3. Volume anomaly & CVD в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ 4. RSI(14) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ 5. EMA ratio 9/21 в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    s = pd.Series(close)
    ...
    # в”Ђв”Ђ 6. Bollinger Bands (20, 2Пѓ) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ 7. Distance to extremes (24h) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ 8. Range в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ 9. Consecutive candles в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ 10. Time (Cyclic) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ 11. РЎР±РѕСЂРєР° в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    vec = np.array([[
        ret_1, ret_3, ret_6,
    ...
    assert vec.shape == (1, len(CRYPTO_FEATURE_COLUMNS)), \
        f"shape {vec.shape} в‰  (1, {len(CRYPTO_FEATURE_COLUMNS)})"
...
def build_features(
    ...
    # в”Ђв”Ђ Volatility в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ Volume anomaly & CVD в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ RSI(14) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    delta = close.diff()
    ...
    # в”Ђв”Ђ EMA ratio 9/21 в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ema9  = close.ewm(span=9,  adjust=False).mean()
    ema21 = close.ewm(span=21, adjust=False).mean()
    out["ema_ratio_9_21"] = ema9 / (ema21 + 1e-10)

    # в”Ђв”Ђ Bollinger Bands (20, 2Пѓ) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ Distance to extremes в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    c = close
    ...
    # в”Ђв”Ђ Range в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    out["range_1"]       = (high - low) / (close + 1e-10)
    out["range_avg_24"]  = out["range_1"].rolling(24, min_periods=6).mean()

    # в”Ђв”Ђ Consecutive candles в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ Time (Cyclic) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    # в”Ђв”Ђ NaN в†’ 0 (safety net) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    out = out.fillna(0.0)
