...
repo_root = Path("C:/Users/orlov/.gemini/antigravity/scratch/flipoly")
...
report = """# Итоговый отчёт приёмки (Final Acceptance Report)
...
with open(repo_root / "acceptance_report.md", "w", encoding="utf-8") as f:
    f.write(report)
