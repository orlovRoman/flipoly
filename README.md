...
> Движок автоматически совершает сделки, применяя управление рисками (Kelly Criterion, дневные лимиты).
...
4. **💰 Торговля (PnL)** — графики PnL, статистика побед/поражений, журнал торгов и панель **Настроек** (Kelly, лимиты, пороги)
...
- **Сайзинг позиций:** Динамический расчёт размера ставки по критерию Келли (ограничен `KELLY_MAX_FRACTION`).
