...
**Статус:** завершено и опубликовано (ветка `research/lgbm-feature-audit-v1`, коммит `2d820dd`)
...
7. Артефакты заморожены и опубликованы в `research/lgbm-feature-audit-v1`
   (коммит `2d820dd`); код и spec лежат в git, тяжёлые промежуточные
   (`FEATURE_MATRIX.parquet`, `_abl_preds/`) воспроизводимы пайплайном F1–F6.
