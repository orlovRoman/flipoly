...
class TradeHistory(Base):
    ...
    # Canonical probabilities and diagnostics emitted by weighted policy.
    p_market_yes = Column(Float, nullable=True)
    p_logreg_yes = Column(Float, nullable=True)
    p_lgbm_yes = Column(Float, nullable=True)
    weighted_policy_mode = Column(String(24), nullable=True)
    weighted_p_market_yes = Column(Float, nullable=True)
    weighted_p_logreg_yes = Column(Float, nullable=True)
    weighted_p_lgbm_yes = Column(Float, nullable=True)
    weighted_p_final_yes = Column(Float, nullable=True)
    weighted_market_weight = Column(Float, nullable=True)
    weighted_logreg_weight = Column(Float, nullable=True)
    weighted_lgbm_weight = Column(Float, nullable=True)
    weighted_mrf_evidence = Column(Float, nullable=True)
    weighted_market_contribution_logodds = Column(Float, nullable=True)
    ...
    weighted_yes_net_ev = Column(Float, nullable=True)
    weighted_no_net_ev = Column(Float, nullable=True)
    weighted_net_ev_per_share = Column(Float, nullable=True)
    weighted_min_net_ev = Column(Float, nullable=True)
    weighted_cost_per_share = Column(Float, nullable=True)
    weighted_fee_rate = Column(Float, nullable=True)
    weighted_maker_fee_rate = Column(Float, nullable=True)
    weighted_execution_role = Column(String(16), nullable=True)
    weighted_fee_exponent = Column(Float, nullable=True)
    weighted_fee_per_share = Column(Float, nullable=True)
    weighted_maker_fee_per_share = Column(Float, nullable=True)
    weighted_taker_fee_per_share = Column(Float, nullable=True)
    weighted_slippage_per_share = Column(Float, nullable=True)
    weighted_spread_per_share = Column(Float, nullable=True)
    weighted_latency_buffer_per_share = Column(Float, nullable=True)
    weighted_expected_execution_price = Column(Float, nullable=True)
    weighted_missing_components = Column(String(128), nullable=True)
    weighted_selection_reason = Column(String(128), nullable=True)
    weighted_fee_source = Column(String(64), nullable=True)
...
class LiveMarket(Base):
    ...
    current_yes_price = Column(Float, nullable=True)
    current_no_price = Column(Float, nullable=True)
...
class DecisionFunnelLog(Base):
    ...
    # Same weighted telemetry is stored for every decision, including SKIP.
    p_market_yes = Column(Float, nullable=True)
    p_logreg_yes = Column(Float, nullable=True)
    p_lgbm_yes = Column(Float, nullable=True)
    weighted_policy_mode = Column(String(24), nullable=True)
