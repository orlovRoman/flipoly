...
function readConfig() {
  ...
  return {
    ...
    auto_dead_zone_width: parseFloat(document.getElementById('cfg-dead-zone').value) / 100,
  ...
  try {
    ...
    if (data.result) {
      ...
      if (cfg) {
        ...
        document.getElementById('cfg-dead-zone').value  = cfg.auto_dead_zone_width != null ? (cfg.auto_dead_zone_width * 100).toFixed(0) : '10';
