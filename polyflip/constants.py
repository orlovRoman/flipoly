...
LIVE_POLL_INTERVAL_SECONDS = 15        # интервал опроса коллектора по умолчанию (15 сек)
TRADE_JOB_INTERVAL_SECONDS = 15        # интервал работы торгового движка по умолчанию (15 сек)
