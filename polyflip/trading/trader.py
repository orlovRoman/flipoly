...
class PolyTrader:
    ...
    async def execute_trade(
        ...
        if not client:
            ...
            return {"status": "SUCCESS", "mode": "PAPER", "error_msg": None, "executed_size": size, "executed_price": price}
        ...
        for attempt in range(1, max_retries + 1):
            try:
                ...
                if resp and resp.get("success"):
                    ...
                    return {"status": "SUCCESS", "mode": "LIVE", "error_msg": None, "executed_size": current_size, "executed_price": price}
        ...
        return {"status": "FAILED", "mode": "LIVE", "error_msg": "Max retries exceeded", "executed_size": 0.0, "executed_price": 0.0}
