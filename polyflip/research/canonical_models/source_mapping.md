...
- PAPER reconciliation (working PAPER loop, not live orders): 8 overlapping markets matched on final BUY/SKIP action with 0 BUY among them — SKIP-only agreement, weak evidence for transfer fidelity. Time/inputs/reasons/execution match NOT established. One BUY worked example (4375498): CT features reproduced bit-identically (ER 0.3077/sc 0.6154/ac −0.1653, 20 obs), side matches, ask diverges (0.09 live vs 0.2 recon, 29.5 s book age).
